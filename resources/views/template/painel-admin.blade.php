            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{Route('instrutor.index')}}">Instrutores</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="{{ URL::asset('img/userPic.webp') }}">
                            </a>
            ...
            <div class="modal-content">
                ...
                <form id="form-perfil" method="POST" action="{{route('admin.editar', $id_usuario)}}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Nif</label>
                            <input value="{{$usuario->nif}}" type="text" class="form-control" id="nif" name="nif" placeholder="NIF">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{$usuario->password}}" type="text" class="form-control" id="password" name="password" placeholder="password">
                        </div>
                    </div>
